...
async function requestDevice() {
  ...
  const options = { filters: [{ services: ['00001105-0000-1000-8000-00805f9b34fb'] }] };

  const _options = {
    acceptAllDevices: true,
    optionalServices: ["My_service"],
  };
...
async function connectDevice() {
  ...
  const service = await server.getPrimaryService("00001105-0000-1000-8000-00805f9b34fb");
  console.log(service)

  heartRate = await service.getCharacteristic("00001005-0000-1000-8000-00805f9b34fb");
